...
const VerifyNotice = () => {
    ...
    const handleSendCode = () => {
        toast.success('Code sent succssfully', {
            id: "code-sent"
        })
                    ...
                    <div className='w-full lg:col-span-3 md:py-10'>
                        <div className="w-full max-w-3xl">
                            ...
                            <div className="flex gap-4">
                                ...
                                <Button onClick={handleSendCode} className="flex-1 shadow-none cursor-pointer py-6 bg-[#0d9488] hover:bg-[#0b5f5a] text-white">Send Code</Button>
                            </div>
                        </div>
                    </div>
                </div>
