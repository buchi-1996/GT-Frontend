...
const MenuItem = ({ title, icon, href, isActive }: NavigationItem) => {
    ...
    return (
        <li>
            <Link href={`${href}`} className={` ${isActive && 'bg-[#E6F8F4] hover:bg-[#E6F8F4]'} w-full flex items-center p-6 rounded-lg text-[#383838] hover:bg-gray-50 hover:text-[#222222] px-3 py-3 gap-3`}>
