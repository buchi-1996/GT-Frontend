        ...
        items: [
            {
                id: "overview-item",
                title: "Overview",
                href: "/receiver/dashboard/overview",
                icon: (
            ...
            },
            {
                ...
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M10.41 19.968C7.59 17.858 2 13.035 2 8.694 2 5.826 4.105 3.5 7 3.5c1.5 0 3 .5 5 2.5 2-2 3.5-2.5 5-2.5 2.895 0 5 2.326 5 5.194 0 4.34-5.59 9.164-8.41 11.274-.95.71-2.23.71-3.18 0Z" /></svg>
                ),
            },
            {
                id: "pickup-item",
            ...
            },
            {
                id: "reputation-item",
                title: "Reputation",
                href: "/receiver/dashboard/reputation",
                icon: (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            },
            {
                id: "community-item",
                title: "Community",
                href: "/receiver/dashboard/community",
                icon: (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M15.483 11.3499C15.805 11.4475 16.1465 11.5 16.5003 11.5C18.4333 11.5 20.0003 9.933 20.0003 8C20.0003 6.067 18.4333 4.5 16.5003 4.5C14.6854 4.5 13.1931 5.8814 13.0176 7.65013" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        ...
        items: [
            {
                id: "settings-item",
                title: "Settings",
                href: "/receiver/dashboard/settings",
                icon: (
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='py-3 px-4 flex flex-col flex-1  items-start justify-between'>
                    <div className='w-full flex flex-col justify-between h-full gap-6 divide-y'>
                        ...
                        <ul className='list-none grid gap-1 sm:gap-2 pb-5'>
                            ...
                            <Button onClick={handleVerifyId} className={`flex lg:hidden bg-[#0d9488] hover:bg-[#0b5f5a]/90 cursor-pointer text-white px-6 py-6 rounded-md items-center ${sidebarCollapsed ? 'justify-center' : 'justify-between'}  gap-2 shadow-none mb-2`}>
                                <div className='flex items-center gap-4'>
                                    <span>
                                        <Verified />
                                    </span>
                                    <p className={`${sidebarCollapsed && 'hidden'}`} >Verify ID</p>
                                </div>
                                <ChevronRight className={`${sidebarCollapsed && 'hidden'} sr-only w-6 h-6`} />
                            </Button>
                        ...
                        <ul className='list-none grid gap-1 sm:gap-2 '>
                            ...
                            <li onClick={() => {
                                ...
                                <p className={` ${sidebarCollapsed ? 'hidden' : 'block'}`}>Logout</p>
                            </li>
                        </ul>
                    </div>
                    <div className={`${sidebarCollapsed && 'hidden'} grid gap-6 my-8 w-full`}>
                        ...
                        {/* Need Help */}
                        <Card className="bg-[#ffffff] shadow-none border w-full h-auto py-3">
                            <CardContent className="px-3 sm:px-5">
