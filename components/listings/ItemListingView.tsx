                        ...
                        <div className="flex gap-6 bg-white rounded-lg">
                            {tabs.map((tab) => (
                                <button
                                    ...
                                    className={`px-4 py-2 whitespace-nowrap rounded-md text-[0.9rem] font-medium transition-colors flex items-center gap-2 ${activeTab === tab.id ? "bg-green-bg text-green-text" : "text-gray-600 hover:text-gray-900"
                                        }`}
                                >
                                    {tab.label}
                                    <Badge variant="secondary" className={`text-gray-600 ${activeTab === tab.id && 'bg-white'} text-xs`}>
                                        {getTabCount(tab.id)}
                                    </Badge>
                                </button>
                            ))}
