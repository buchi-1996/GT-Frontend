                                ...
                                <div className='flex items-center gap-2 justify-between'>
                                    <span>
                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M21 5.8999V8.1499H3V5.8999C3 5.70099 3.07902 5.51022 3.21967 5.36957C3.36032 5.22892 3.55109 5.1499 3.75 5.1499H20.25C20.4489 5.1499 20.6397 5.22892 20.7803 5.36957C20.921 5.51022 21 5.70099 21 5.8999Z" fill="black" fill-opacity="0.04" />
