...
export function BasicInfoSection({ form }: BasicInfoSectionProps) {
  return (
    <div className="@container grid gap-8 border py-6 px-4 md:px-6 rounded-lg">
      <div className='@container flex items-center border-b pb-4 justify-between'>
        <div className='flex gap-6 items-center w-fit'>
          <div className='relative min-w-fit'>
            <Image src="/assets/5d1e58c8086fe7ad86b64a6151f47a2a2aa8357a.png" alt="profile image" width={400} height={500} className='rounded-full h-[82px] w-[82px]' />
          ...
          <div className="flex flex-col items-start gap-3">
            ...
            <div className='flex gap-4 items-center'>
              <Button variant="secondary" id="picture" asChild>
                <Label htmlFor="picture" >Browse...</Label>
              </Button>
              <p className='text-sm text-gray-500'>No file choosen</p>
            </div>
          </div>
        </div>
        <Button className='hidden md:@lg:block' variant="secondary">Verify account</Button>
      </div>
      ...
      <Button className='block md:@lg:hidden py-4 h-12' variant="secondary">Verify account</Button>
