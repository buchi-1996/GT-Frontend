...
const submitAbuseProps = z.object({
    issueType: z.string(),
    description: z.string().optional()
})
type SubmitAbusePropsSchema = z.infer<typeof submitAbuseProps>;
...
const HelpAndSupportView = () => {
    ...
    const form = useForm<SubmitAbusePropsSchema>({
        resolver: zodResolver(submitAbuseProps),
        defaultValues: {
            issueType: "",
            description: ""
    ...
    return (
        <div className="grid gap-6">
            <div className='p-4 md:p-6 rounded-lg border'>
                ...
                <div className="@container py-6 border-b box-border">
                    ...
                    <Tabs value={activeTab} onValueChange={handleTabChange}>
                        <ScrollArea className="w-full max-w-full overflow-x-auto">
                            <TabsList className="items-start grid auto-cols-max shrink-1 grid-flow-col mb-6 gap-2 bg-gray-50 p-1 h-auto bg-transparent rounded-lg">
                                <TabsTrigger
                                    value="all"
            ...
            {isReceiver && <div className="py-6 border rounded-lg p-6 box-border">
                <h3 className="font-semibold text-[#222222] mb-8">Report a Problem or Abuse</h3>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit((data) => {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-gray-500">Issue Type</FormLabel>
                                    <FormControl>
                                        <Select onValueChange={field.onChange} value={field.value || ""}>
                                            ...
                                            <SelectContent className="shadow-xl w-full border-none px-1 py-2">
                                                <SelectItem value="spam" className="py-3 px-4">Spam or Scam</SelectItem>
                                                <SelectItem value="inappropriate-content" className="py-3 px-4">Inappropriate Content</SelectItem>
                                                <SelectItem value="harassment" className="py-3 px-4">Harassment or Abuse</SelectItem>
                        ...
                        <Button type="submit" variant="destructive_inverted" className='w-auto py-5 ml-auto'>Submit Report</Button>

                    </form>
                </Form>
            </div>}
            {isReceiver && <div className="bg-[#f9fafb] p-4 rounded-lg flex items-center  gap-4 justify-between">
                <div>
                    <h4 className="font-semibold text-sm text-[#222222] mb-1">Emergency Contact</h4>
                    <p className="text-sm text-[#626262]">If you&apos;re experiencing harassment, threats, or feel unsafe, please contact us immediately:</p>
                </div>
                <Button className='w-auto cursor-pointer py-5 bg-white text-gray-600 shadow-none border hover:bg-white hover:text-gray-600 capitalize'>Call emergency line</Button>
            </div>}
        </div>
    )
}
