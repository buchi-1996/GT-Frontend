...
const VerifyIdModal = () => {
    ...
    const {verifyIdInProgressModalOpen, verificationModalOpen} = useAppSelector((state) => state.modal);
    ...
    return (
        <>
            {/* Verify Modal */}
            <ResponsiveModal open={verificationModalOpen} close={() => dispatch(showVerificationModal(false))} className="p-4 min-h-[90%] md:min-h-auto">
            ...
            <ResponsiveAlert open={verifyIdInProgressModalOpen} close={() => dispatch(showVerifyIdInProgressModal(false))} className="p-4">
                <div className="flex flex-col items-center justify-center text-center space-y-4 py-12">
                    ...
                    <div className="pt-4">
                        <Button variant="primary" onClick={() => dispatch(showVerifyIdInProgressModal(false))} className="py-6 w-full sm:w-44">
                            Got it
                        </Button>
                    </div>
                </div>
